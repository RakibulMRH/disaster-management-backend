 ...
 */
router.post('/register', [auth_middleware_1.authMiddleware, (0, role_middleware_1.roleMiddleware)(['Admin'])], userController.registerUser);
/**
 * @swagger
 * /users/{id}:
 *   get:
 ...
 *         description: User not found
 */
router.delete('/:id', [auth_middleware_1.authMiddleware, (0, role_middleware_1.roleMiddleware)(['Admin'])], userController.deleteUser);
/**
 * @swagger
 * /users:
 *   get:
